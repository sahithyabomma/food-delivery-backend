...
public class GlobalExceptionHandler {
    ...
    @ExceptionHandler(UnauthorizedRestaurantOperationException.class)
    public ResponseEntity<ErrorResponse>
    handleUnauthorizedRestaurantOperation(
            UnauthorizedRestaurantOperationException exception
    ) {
    ...
    @ExceptionHandler({
            ...
            InventoryConcurrencyException.class
    })
    public ResponseEntity<ErrorResponse> handleInventoryConcurrency(
            Exception exception
    ) {
        ErrorResponse response = new ErrorResponse(
                Instant.now(),
                HttpStatus.CONFLICT.value(),
                HttpStatus.CONFLICT.getReasonPhrase(),
                InventoryConcurrencyException.MESSAGE,
                Map.of()
        );
